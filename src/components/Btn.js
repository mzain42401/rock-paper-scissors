...
<div onClick={refresh} className='md:relative absolute md:top-0 top-2 left-2  cursor-pointer bg-[#3f3f46] text-white rounded-full  md:text-xl px-3 py-2 text-lg flex justify-center items-center'><p className='mr-2'>Play Again </p><LuRefreshCcw/></div>
