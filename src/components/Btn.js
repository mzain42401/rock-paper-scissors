...
setpcwin(true)
  ...
  return (
    ...
    <div className='select-none'>
      <p className={`${icon?"text-white":"text-[#1b1b1f]"} text-center `}>Whoever wins 10 rounds first will win the game</p>
    <nav className='select-none  flex justify-between items-center px-4 pt-1'>

<div onClick={refresh} className='md:relative absolute md:top-0 top-2 left-2  cursor-pointer bg-[#3f3f46] text-white rounded-full  md:h-14 md:w-14 h-10 w-10 md:text-3xl text-xl px-3 py-2 text-lg flex justify-center items-center'><LuRefreshCcw/></div>
